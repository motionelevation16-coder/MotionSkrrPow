# Cold Email Templates — Deutsch (DE/AT/CH)

*Motion Elevation — Automatisierung für Ihr Unternehmen*

---

## Template 1: Der Direkte Ansatz

**Betreff:** {Vorname}, spart {Firmenname} 10 Stunden pro Woche?

**Text:**

Hallo {Vorname},

kurze Frage: Wie viele Stunden verbringt Ihr Team mit wiederkehrenden Aufgaben — Rechnungen, Terminplanung, E-Mail-Nachfassen?

Wir automatisieren genau diese Prozesse. Keine Software-Schulung. Keine IT-Projekte. Wir bauen es, Sie nutzen es.

Ein Kunde aus {Branche} spart jetzt 12 Stunden pro Woche. Ohne neuen Mitarbeiter einzustellen.

Haben Sie 10 Minuten diese Woche für einen kurzen Austausch?

Beste Grüße,
{Absender}
Motion Elevation

P.S. — Falls nicht relevant, einfach ignorieren. Kein Spam.

---

## Template 2: Problem-Fokus (Branchenspezifisch)

**Betreff:** Das nervigste an {Branche}? Wir lösen es.

**Text:**

Hallo {Vorname},

ich weiß, dass in {Branche} oft dieselben Aufgaben Zeit fressen:
- Manuelle Dateneingabe
- Kundennachfragen beantworten
- Termine koordinieren
- Berichte erstellen

Was, wenn das automatisch läuft? Im Hintergrund. Ohne Ihr Zutun.

Wir machen genau das — für Unternehmen wie {Firmenname}.

Interesse an einem 10-Minuten-Gespräch?
...
## Template 3: Konkrete Zahl

**Betreff:** 247€/Monat. 10+ Stunden gespart. Rechnet sich.
...
- Mindestlohn in Deutschland: ~€2.054/Monat
- Unsere Automatisierung: €247/Monat
- Ersparnis: 10+ Arbeitsstunden pro Woche

Das ist kein Software-Abo, das verstaubt. Das ist ein digitaler Mitarbeiter, der sofort arbeitet.

Wir haben Kapazität für 3 neue Kunden diesen Monat. Passt {Firmenname} dazu?

Kurzer Call? 15 Minuten maximal.
...
## Template 4: Follow-Up #1 (3 Tage später)
...
kurzes Follow-up — meine letzte Mail ist vielleicht untergegangen.

Die Kernfrage: Gibt es wiederkehrende Aufgaben in Ihrem Alltag, die Sie gerne automatisieren würden?

Falls ja → 10-Minuten-Call, ich zeige Ihnen was möglich ist.
Falls nein → Kein Problem, ich hake nicht weiter nach.
...
## Template 5: Follow-Up #2 (7 Tage später)
...
ich möchte nicht nerven — das ist meine letzte Nachricht.

Falls Automatisierung gerade kein Thema ist, völlig okay. Ich speichere Ihren Kontakt und melde mich in 6 Monaten nochmal.

Falls Sie doch neugierig sind: Ein kurzer Anruf, 10 Minuten, zeigt Ihnen konkret, was wir für {Branche} automatisieren können.
...
## Template 6: Referral/Sozial Proof

**Betreff:** Was {Referenz-Firma} jetzt anders macht

**Text:**

Hallo {Vorname},

{Referenz-Firma} aus {Stadt} hat uns vor 3 Monaten beauftragt.

Seitdem läuft automatisch:
- Terminbestätigung per E-Mail
- Rechnungsstellung nach Projektabschluss
- Kundenerinnerungen 24h vor Terminen

Ergebnis: 8 Stunden/Woche gespart. Null manuelle Arbeit.

{Firmenname} könnte Ähnliches erreichen. Interesse?
...
- Pain: Kunden-Onboarding, Follow-ups, Projektübergaben
- Lösung: Automatisierte Client-Flows

### Für Handwerker/Lokale Dienste:
- Pain: Terminplanung, Angebote schreiben, Erinnerungen
- Lösung: Automatische Buchung + Bestätigung

### Für E-Commerce:
- Pain: Retouren, Kundenanfragen, Bestandsmeldungen
- Lösung: Bot-Support + automatische Prozesse

### Für Ärzte/Praxen:
- Pain: Terminvergabe, Erinnerungen, Patientenkommunikation
- Lösung: 24/7 automatische Terminbuchung

---

## Sprachliche Tipps

1. **Du vs. Sie:** Immer "Sie" für B2B in DACH — professioneller
2. **Direktheit:** Deutsche schätzen Klarheit — keine Marketing-Floskeln
3. **Zahlen:** Konkrete Zahlen wirken überzeugend (10 Stunden, €247, 3 Kunden)
4. **Kürze:** Kurze Sätze. Kurze Absätze. Respekt für ihre Zeit.
5. **P.S.:** Wird oft zuerst gelesen — wichtigste Info dort
